...
asn_TYPE_descriptor_t asn_DEF_ran_ControlActionParameters_List_4 = {
	...
	{ 0, &asn_PER_type_ran_ControlActionParameters_List_constr_4, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_ueGroup_ControlAction_Supported_7 = {
	...
	{ 0, &asn_PER_type_ueGroup_ControlAction_Supported_constr_7, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_RANFunctionDefinition_Control_Action_Item_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct RANFunctionDefinition_Control_Action_Item, ran_ControlActionParameters_List),
		...
		0,
		{ 0, &asn_PER_memb_ran_ControlActionParameters_List_constr_4,  memb_ran_ControlActionParameters_List_constraint_1 },
		0, 0, /* No default value */
		"ran-ControlActionParameters-List"
		},
