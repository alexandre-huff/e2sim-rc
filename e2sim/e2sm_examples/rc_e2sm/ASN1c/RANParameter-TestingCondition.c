...
asn_TYPE_descriptor_t asn_DEF_ranP_Choice_comparison_2 = {
	...
	{ 0, &asn_PER_type_ranP_Choice_comparison_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_ranP_Choice_presence_10 = {
	...
	{ 0, &asn_PER_type_ranP_Choice_presence_constr_10, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_RANParameter_TestingCondition = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_RANParameter_TestingCondition_constr_1, CHOICE_constraint },
